...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        rb2D.linearVelocity = new Vector2(movementInput * moveSpeed, rb2D.linearVelocity.y);                //ground movement
    ...
    public void Jump(InputAction.CallbackContext context)
    {
        if (context.performed )  //button down
        {
            ...
            {
                JumpBufferTimer = originalJumpBufferTimer;     //start input buffer timer
    ...
    public void Jump(float NewGracityScale, float NewJumpPower, bool allowGracityReset)
    {
        ...
        bJumpGravityReset = allowGracityReset;
    }
